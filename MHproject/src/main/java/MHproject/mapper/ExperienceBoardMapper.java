...
public interface ExperienceBoardMapper {
	 ...
	 * @return 게시글 상세 정보
	 */
	ExperienceBoardDTO selectBoardDetailWithLike(@Param("boardIdx") int boardIdx, @Param("userId") String userId) throws Exception;
	 ...
	 */
	public List<ExperienceBoardDTO> searchTitleBoardListWithLike(@Param("keyword") String keyword, @Param("userId") String userId);
	
	/**
	 * 내용 검색 시 사용자의 좋아요 여부 포함
	 */
	public List<ExperienceBoardDTO> searchContentsBoardListWithLike(@Param("keyword") String keyword, @Param("userId") String userId);
