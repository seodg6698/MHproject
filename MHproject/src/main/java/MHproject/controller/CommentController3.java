...
public class CommentController3 {
    ...
    public ResponseEntity<Map<String, Object>> insertComment(
        ...
        try {
            ...
            // 댓글 DTO 생성
            CommentDto3 comment = new CommentDto3(boardIdx, parentIdx, content, user.getUserid());
    ...
    public ResponseEntity<Map<String, Object>> updateComment(
        ...
        try {
            ...
            // 댓글 DTO 생성
            CommentDto3 comment = new CommentDto3();
