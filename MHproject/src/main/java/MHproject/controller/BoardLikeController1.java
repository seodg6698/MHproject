...
public class BoardLikeController1 {
    
    private static final Logger logger = LoggerFactory.getLogger(BoardLikeController1.class);
    
    @Autowired
    private BoardLikeService1 boardLikeService;
