...
@Service
public class BoardLikeServiceImpl1 implements BoardLikeService1 {
    
    private static final Logger logger = LoggerFactory.getLogger(BoardLikeServiceImpl1.class);
    
    @Autowired
    private BoardLikeMapper1 boardLikeMapper;
